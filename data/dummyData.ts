...
export const products: Product[] = [
  { id: 1, name: 'Serabi Hijau Khas Karawang', price: 15000, category: 'Kuliner', description: 'Serabi hijau otentik dengan saus kinca durian.', stock: 50, sellerId: 1, discount: 10, imageUrl: `https://via.placeholder.com/600/E5E7EB/4B5563?text=Serabi+Hijau` },
  { id: 2, name: 'Batik Karawang Motif Padi', price: 250000, category: 'Fashion', description: 'Kain batik tulis dengan motif padi khas lumbung padi Jawa Barat.', stock: 20, sellerId: 2, imageUrl: `https://via.placeholder.com/600/E5E7EB/4B5563?text=Batik+Karawang` },
  { id: 3, name: 'Anyaman Bambu Hias', price: 75000, category: 'Kerajinan', description: 'Hiasan dinding dari anyaman bambu asli Karawang.', stock: 30, sellerId: 3, discount: 25, imageUrl: `https://via.placeholder.com/600/E5E7EB/4B5563?text=Anyaman+Bambu` },
  { id: 4, name: 'Beras Pandan Wangi Organik', price: 80000, category: 'Pertanian', description: 'Beras organik 5kg, pulen dan wangi alami.', stock: 100, sellerId: 4, imageUrl: `https://via.placeholder.com/600/E5E7EB/4B5563?text=Beras+Organik` },
  { id: 5, name: 'IoT Sawah Pintar Kit', price: 1500000, category: 'Teknologi', description: 'Kit sensor untuk memantau kondisi sawah secara real-time.', stock: 10, sellerId: 5, imageUrl: `https://via.placeholder.com/600/E5E7EB/4B5563?text=IoT+Sawah` },
  { id: 6, name: 'Jasa Foto Produk UMKM', price: 500000, category: 'Jasa', description: 'Paket jasa foto produk profesional untuk 20 item.', stock: 99, sellerId: 6, imageUrl: `https://via.placeholder.com/600/E5E7EB/4B5563?text=Jasa+Foto` },
  { id: 7, name: 'Pelatihan UMKM Go Digital', price: 300000, category: 'Edukasi', description: 'Workshop 2 hari tentang pemasaran digital untuk UMKM.', stock: 99, sellerId: 7, imageUrl: `https://via.placeholder.com/600/E5E7EB/4B5563?text=Pelatihan+UMKM` },
  { id: 8, name: 'Dodol Karawang Premium', price: 45000, category: 'Kuliner', description: 'Dodol legit dengan bahan pilihan dan resep turun-temurun.', stock: 80, sellerId: 8, discount: 15, imageUrl: `https://via.placeholder.com/600/E5E7EB/4B5563?text=Dodol+Premium` },
  { id: 9, name: 'Kaos Lokal "Karawang Pride"', price: 120000, category: 'Fashion', description: 'Kaos katun combed 30s dengan sablon desain lokal.', stock: 60, sellerId: 9, imageUrl: `https://via.placeholder.com/600/E5E7EB/4B5563?text=Kaos+Lokal` },
  { id: 10, name: 'Gerabah Artistik', price: 150000, category: 'Kerajinan', description: 'Vas gerabah dengan ukiran tangan yang unik.', stock: 25, sellerId: 10, imageUrl: `https://via.placeholder.com/600/E5E7EB/4B5563?text=Gerabah+Artistik` },
  { id: 11, name: 'Pupuk Cair Organik Super', price: 50000, category: 'Pertanian', description: 'Pupuk cair organik 1 liter untuk kesuburan tanaman.', stock: 200, sellerId: 4, discount: 5, imageUrl: `https://via.placeholder.com/600/E5E7EB/4B5563?text=Pupuk+Organik` },
  { id: 12, name: 'Jasa Desain Logo UMKM', price: 400000, category: 'Jasa', description: 'Jasa desain logo profesional termasuk 3 revisi.', stock: 99, sellerId: 6, imageUrl: `https://via.placeholder.com/600/E5E7EB/4B5563?text=Jasa+Desain` }
];
