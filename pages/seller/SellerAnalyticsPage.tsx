...
const SellerAnalyticsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-bold">Analitik Toko</h1>
        <p className="text-neutral-600 mt-1">Pahami performa toko Anda untuk mengambil keputusan yang lebih baik.</p>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        <h3 className="text-lg font-bold mb-4">Performa Produk Terlaris (30 hari)</h3>
      ...
      {/* Traffic Sources */}
      <div className="bg-white p-6 rounded-lg shadow-md">
        <h3 className="text-lg font-bold mb-4">Lalu Lintas Pengunjung (30 hari)</h3>
        <div className="space-y-4">
          {trafficSourceData.map(item => (
            <div key={item.source}>
              <div className="flex justify-between items-center text-sm mb-1">
                <span className="font-medium text-neutral-700">{item.source}</span>
                <span className="text-neutral-500">{item.visitors.toLocaleString('id-ID')} Pengunjung</span>
              </div>
